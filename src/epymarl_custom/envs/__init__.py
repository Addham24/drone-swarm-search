...
def smaclite_fn(**kwargs) -> MultiAgentEnv:
    if SMACliteWrapper is None:
        raise ImportError("smaclite is not installed. Please install it using env_requirements.txt or by running pip install git+https://github.com/uoe-agents/smaclite.git")
