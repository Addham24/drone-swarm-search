import argparse
"""
QMIX (DQN) Vanilla Test Script for Drone Swarm Coverage
=========================================================
Tests a trained QMIX Vanilla checkpoint (no self-healing features).

Usage:
    python test_qmix_vanilla.py
"""
...
from train_qmix_vanilla import QMIXVanillaCNNModel
...
def env_creator(render_mode="human"):
    print("-------------------------- QMIX VANILLA ENV CREATOR (TEST) --------------------------")
    N_AGENTS = 4
...
if __name__ == "__main__":
    ...
    print("Please enter the absolute path to the QMIX Vanilla checkpoint.")
    ...
    print(f"  QMIX VANILLA TEST — 4 Drones on 25x25 Grid")
    ...
    print(f"\n{Colors.CYAN}{Colors.BOLD}{'='*60}")
    print(f"  QMIX VANILLA TEST FINISHED — {step_count} steps")
    print(f"{'='*60}{Colors.RESET}")
